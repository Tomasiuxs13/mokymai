/* ============================================================
   Web Genius — i18n translation strings (EN / LT)
   Loaded before script.js; exposes a global `i18n` object.
   ============================================================ */
...
const i18n = {
    en: {
        ...
        'footer.data_request': 'Data Request (GDPR)',
        ...
        'modal.consent_text': 'I am the parent or legal guardian of the child being registered, and I agree to the <a href="privacy.html" target="_blank" rel="noopener">Privacy Policy</a> and <a href="terms.html" target="_blank" rel="noopener">Terms of Service</a>.',
        'err.name': 'Please enter a full name (at least 2 characters).',
        'err.email': 'Please enter a valid email address.',
        'err.phone': 'Please enter a valid phone number.',
        'err.cohort': 'Please select a cohort.',
        'err.consent': 'Parental consent is required to register.',
        'err.network': 'Could not connect. Please check your internet and try again.',
        'err.generic': 'Something went wrong. Please try again or contact us.',
    ...
    lt: {
        ...
        'footer.data_request': 'Duomenų užklausa (BDAR)',
        ...
        'modal.consent_text': 'Esu registruojamo vaiko tėvas, motina ar teisėtas globėjas ir sutinku su <a href="privacy.html" target="_blank" rel="noopener">privatumo politika</a> bei <a href="terms.html" target="_blank" rel="noopener">paslaugų teikimo sąlygomis</a>.',
        'err.name': 'Įveskite vardą ir pavardę (bent 2 simboliai).',
        'err.email': 'Įveskite teisingą el. pašto adresą.',
        'err.phone': 'Įveskite teisingą telefono numerį.',
        'err.cohort': 'Pasirinkite grupę.',
        'err.consent': 'Tėvų sutikimas yra privalomas.',
        'err.network': 'Nepavyko prisijungti. Patikrinkite interneto ryšį.',
        'err.generic': 'Kažkas nepavyko. Bandykite dar kartą arba susisiekite su mumis.',
